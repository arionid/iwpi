$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "../adm-assets/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-2').DataTable({
        "ajax": '../adm-assets/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        ...
        "ajax": "../adm-assets/json/server-side.json"
    } );
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "../adm-assets/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "../adm-assets/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "../adm-assets/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "../adm-assets/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "../adm-assets/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },
