      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="#"><span class="date">23/7/20</span><span class="badge badge-primary f-right">medium</span>
                                ...
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../adm-assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                ...
                                <div class="d-flex mt-3">
                                  ...
                                  <div class="customers">
                                    <ul>
                                      ...
                                      <li class="d-inline-block"><img class="img-20 rounded-circle" src="../adm-assets/images/user/3.jpg" alt="" data-original-title="" title=""></li>
                                      <li class="d-inline-block"><img class="img-20 rounded-circle" src="../adm-assets/images/user/1.jpg" alt="" data-original-title="" title=""></li>
                                      <li class="d-inline-block"><img class="img-20 rounded-circle" src="../adm-assets/images/user/5.jpg" alt="" data-original-title="" title=""></li>
                                    </ul>
                                  </div>
                                </div></a>
                            `,
  ...
  boards: [{
    ...
    },
    {
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="badge badge-danger f-right">Argent</span>
                                <img class="mt-2 img-fluid" src="../adm-assets/images/other-images/maintenance-bg.jpg" alt="" data-original-title="" title="">
                                <h6>Test Sidebar</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../adm-assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>Themeforest, australia</p>
    ...
    },
    {
      ...
      'item': [{
        ...
        },
        {
          'title': `
                               <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="badge badge-danger f-right">Argent</span>
                                <img class="mt-2 img-fluid" src="../adm-assets/images/other-images/sidebar-bg.jpg" alt="" data-original-title="" title="">
                                <h6>Test Sidebar</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../adm-assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>Themeforest, australia</p>
