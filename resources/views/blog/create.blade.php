                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input name="title" class="form-control @error('title') is-invalid @enderror" id="inpTitle" type="text" placeholder="Post Title"
                                        required="" value="{{ old('title') }}" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)">
                                </div>
                                <div class="mb-3">
                                    <label>Slug:</label>
				...
				<h6 class="mb-0">Drop files here or click to upload.</h6>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <div class="m-checkbox-inline">
                                    <label for="status_published">
                                        <input name="status" class="radio_animated" id="status_published" type="radio" value="1" checked="">Publish
                                    </label>
                                    <label for="status_schedule">
                                        <input name="status" class="radio_animated" id="status_schedule" type="radio" value="2">Schedule
                                    </label>
                                    <label for="status_draft">
                                        <input name="status" class="radio_animated" id="status_draft" type="radio" value="0">Draft
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="published_at" class="form-control digits" type="datetime-local"
                                    value="{{ old('meta_title') ?? Carbon\Carbon::now()->format('Y-m-d h:i:s') }}">
                            </div>
