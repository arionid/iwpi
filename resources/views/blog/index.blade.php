                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    @if ($item->status == 1)
                                                        <i class="font-success" data-feather="check-circle"></i><span class="font-success fw-bold p-l-5"> Publish</span>
                                                    @elseif($item->status == 2)
                                                        <i class="txt-primary" data-feather="clock"></i><span class="txt-primary fw-bold p-l-5"> Schedule</span>
                                                    @else
                                                        <i class="font-danger" data-feather="alert-triangle"></i><span class="font-danger fw-bold p-l-5"> Draft</span>
                                                    @endif
                                                </td>
