                        ...
                        <form action="{{ route('blog.update', $data->id) }}" method="POST" class="row" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input name="title" class="form-control @error('title') is-invalid @enderror" id="inpTitle" type="text" placeholder="Post Title"
                                        required="" value="{{ $data->title ?? '' }}" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)">
                                </div>
                                <div class="mb-3">
                                    <label>Slug:</label>
                                    <input name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug_title" type="text" placeholder="Post Slug" required=""
                                        value="{{ $data->slug ?? '' }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted" id="emailHelp">File Gambar yang di ijikan upload hanya file dengan extension <b>[.jpg, .jpeg, .png]</b> dengan
                                        ukuran file maksimal <b>2Mb</b></small>
                                </div>
                            </div>
			  ...
			  <div class="m-0 dz-message needsclick"><i class="icon-cloud-up"></i>
				<h6 class="mb-0">Drop files here or click to upload.</h6>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="meta_description" class="form-control" id="inpMetaDesc" type="text" placeholder="Meta Description"
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <div class="m-checkbox-inline">
                                    <label for="status_published">
                                        <input name="status" class="radio_animated" id="status_published" type="radio" value="1"
                                            @if ($data->status == '1') checked="" @endif>Publish
                                    </label>
                                    <label for="status_schedule">
                                        <input name="status" class="radio_animated" id="status_schedule" type="radio" value="2"
                                            @if ($data->status == '2') checked="" @endif>Schedule
                                    </label>
                                    <label for="status_draft">
                                        <input name="status" class="radio_animated" id="status_draft" type="radio" value="0"
                                            @if ($data->status == '0') checked="" @endif>Draft
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="published_at" class="form-control digits" type="datetime-local"
                                    value="{{ $data->published_at ?? Carbon\Carbon::now()->format('Y-m-d h:i:s') }}">
                            </div>
