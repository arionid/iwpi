				...
				<div class="blog-box blog-shadow">
					...
					<div class="blog-details">
						...
						<ul class="blog-social">
							...
							<li class="digits"><i class="icofont icofont-contrast"></i>@if($blog[0]->status == '1') <b>Published</b> @else <b class="text-danger">Draft</b> @endif</li>
                            ...
                            <div class="blog-details">
                                ...
                                <div class="blog-bottom-content">
                                    <ul class="blog-social">
                                        ...
                                        <li>@if($item->status == '1') <b class="txt-success">Published</b> @else <b class="txt-danger">Draft</b> @endif</li>
                                    </ul>
                                    <hr>
                    ...
                    <div class="blog-box blog-grid text-center">
                        ...
                        <div class="blog-details-main">
                            <ul class="blog-social">
                                ...
                                <li class="digits">@if($item->status == '1') <b class="text-success">Published</b> @else <b class="text-danger">Draft</b> @endif</li>
                            </ul>
                            <hr>
