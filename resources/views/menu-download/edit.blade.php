...
@section('title', 'Edit Data Menu Download')
            ...
            <div class="col-sm-8">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('menu-download.update', $data->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                        <input type="text" name="nama_file" placeholder="Masukkan Nama Dokumen" class="form-control fw-bold"
                                            value="{{ $data->nama ?? old('nama_file') }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group {{ $errors->has('dokumen') ? ' has-error' : '' }} d-flex flex-column">
                                        ...
                                        @if (isset($data->file))
                                            <a href="{{ asset('uploads/' . $data->file) }}" target="_blank" class="btn btn-sm btn-primary">Buka File Dokumen</a>
                                        @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
                                        <textarea name="deskripsi" class="form-control" rows="5">{!! $data->keterangan !!}</textarea>
