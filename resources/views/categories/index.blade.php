                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <div class="header-top border-bottom pb-3">
                            <h5>Table Categories</h5>
                            <div class="card-header-right-icon create-right-btn"><a class="btn badge-light-primary f-w-500 f-12" href="{{ route('categories.create') }}">Tambah +</a></div>
                          </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="{{ route('categories.edit', $item->id) }}"><i class="icon-pencil-alt"></i></a>
                                                </li>
                                    ...
                                    @else
                                    <tr>
                                        <td colspan="7">Data Categories is Empty</td>
                                    </tr>
                                    @endisset
...
@section('script')
    ...
    <script>
        function formRemoveData(dataid){
            $("#form-deleteData").attr('action', '{{ url('/adm/categories') }}/'+dataid);
