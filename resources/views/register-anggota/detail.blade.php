        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-sm-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('register-anggota.updatestatus', $user->id) }}" id="form-konfirmasi-anggota" class="theme-form" method="POST">
                            @csrf
                                ...
                                <ul class="pro-services ">
                                    ...
                                    <li>
                                        <div class="media"><i data-feather="phone"></i>
                                            <div class="media-body">
                                                ...
                                                <a href="tel:{{ $user->phone }}" class="text-success"><i class="fa fa-whatsapp me-1 "></i>{{ $user->phone }}</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="media"><i data-feather="image"></i>
                                            <div class="media-body">
                                                <h5>Foto KTP</h5>
                                                <img src="{{ file_exists('uploads/' . $user->file_ktp) ? asset('uploads/' . $user->file_ktp) : 'https://placehold.co/600x350/e8e5ff/7366ff?text=FOTO+KTP&font=Playfair+Displayn' }}"
                                                    class="img-fluid">
                                                <p><a href="{{ asset('uploads/' . $user->file_ktp) }}" target="_blank" class="text-underline">Lihat Foto KTP </a></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="media"><i data-feather="image"></i>
                                            <div class="media-body">
                                                <h5>Foto NPWP</h5>
                                                <img src="{{ file_exists('uploads/' . $user->file_npwp) ? asset('uploads/' . $user->file_npwp) : 'https://placehold.co/600x350/e8e5ff/7366ff?text=FOTO+KTP&font=Playfair+Displayn' }}"
                                                    class="img-fluid">
                                                <p><a href="{{ asset('uploads/' . $user->file_npwp) }}" target="_blank" class="text-underline">Lihat Foto NPWP </a></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="mt-2 row">
                            <a class="btn btn-block btn-success btn-air-success btn-lg" href="//wa.me/{{ fWaNumber($user->phone) }}" title="">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="media"><i data-feather="image"></i>
                                            <div class="media-body">
                                                ...
                                                <img src="{{ file_exists('uploads/' . $user->detail->bukti_bayar)
                                                    ...
                                                    class="img-fluid">
                                                <p><a href="{{ asset('uploads/' . $user->detail->bukti_bayar) }}" target="_blank" class="text-underline">Lihat Bukti Bayar </a></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="m-t-15 btn-group">
                                ...
                                <div class="btn-group" role="group">
                                    <button class="btn btn-danger dropdown-toggle" id="btnGroupDrop1" type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false"><i class="fa fa-times-circle me-1"></i>Tolak Pendaftaran</button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <a class="dropdown-item" href="javascript:void();" onclick="updatestat('Decline')">Tolak Pendaftaran</a>
                                        <a class="dropdown-item" href="javascript:void();" onclick="updatestat('Blacklist')">Block Anggota</a>
                                        <a class="dropdown-item" href="javascript:void();" onclick="updatestat('Overdue')">Nonaktif Anggota</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="media"><i data-feather="info"></i>
                                            <div class="media-body">
                                                <h5>Status Pembayaran <br>
                                                    @if (in_array($user->payment_detail->status, ['deny', 'expired', 'cancel']))
            ...
            <div class="col-sm-9">
                <div class="card">
                    <div class="card-header bg-danger" style="background: #394f89 !important;">
                        <div class="media">
                            <img class="img-100 img-fluid m-r-20 rounded-circle update_img_6" src="{{ asset('/assets/img/logo-white.webp') }}" alt="">
                            <div class="media-body mt-0 f-w-700">
                                <h4>{{ $user->fullname }}</h4>
                                <p>{{ $user->npwp }}</p>
                                @if (!empty($user->detail->nomor_anggota))
                                    <ul>
                                        <li><a href="{{ route('register-anggota.kartu-anggota', $user->detail->nomor_anggota) }}" target="_blank" class="txt-light">Download File
                                                Kartu Anggota</a></li>
                                    </ul>
                                @endif
                            </div>
                    ...
                    <div class="card-body list-persons">
                        <div class="profile-mail">
                            <div class="email-general p-5 f-w-600 f-16">
                                ...
                                <ul class="biodata">
                                    <li>Nomor Anggota IWPI<span
                                            class="font-danger">{{ !empty($user->detail->nomor_anggota) ? $user->detail->nomor_anggota : $user->village_id . '.' . sprintf('%04d', $user->id) }}</span>
                                    </li>
