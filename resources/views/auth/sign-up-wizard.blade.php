         ...
         <div>
            <div class="theme-form">
               <div class="wizard-4" id="wizard">
                  <ul>
                     <li><a class="logo text-start ps-0" href="{{ route('home') }}"><img class="img-fluid for-light" src="{{asset('adm-assets/images/logo/login.png')}}" alt="looginpage"><img class="img-fluid for-dark" src="{{asset('adm-assets/images/logo/logo_dark.png')}}" alt="looginpage"></a></li>
                     <li>
                        <a href="#step-1">
                           <h4>1</h4>
                           <h5>personal</h5>
                     ...
                     <li>                           <img src="{{asset('adm-assets/images/login/icon.png')}}" alt="looginpage"></li>
                  </ul>
                  <div id="step-1">
...
@section('script')
<script src="{{ asset('adm-assets/js/form-wizard/form-wizard-five.js')}}"></script>
<script src="{{ asset('adm-assets/js/tooltip-init.js')}}"></script>
<script src="{{ asset('adm-assets/js/theme-customizer/customizer.js')}}"></script>
@endsection
